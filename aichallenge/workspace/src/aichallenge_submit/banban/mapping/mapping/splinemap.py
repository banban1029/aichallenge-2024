...
# Define the function to search the nearest index
...
# Define the function to calculate width
def calc_width(x, y, bound_x, bound_y):
    return np.sqrt((x - bound_x)**2 + (y - bound_y)**2)

# Define the function to calculate the center line
...
# Define the function to smooth the center line
...
output_corrected_path = './maps/ai_challenge_smoothed.csv'
...
plt.scatter(smoothed_center_df['x_m'][0], smoothed_center_df['y_m'][0], color='red', marker='o', s=100, label='Start Point')
plt.scatter(smoothed_center_df['x_m'][100], smoothed_center_df['y_m'][100], color='green', marker='o', s=100, label='100')
plt.scatter(smoothed_center_df['x_m'][200], smoothed_center_df['y_m'][200], color='yellow', marker='o', s=100, label='200')
plt.scatter(smoothed_center_df['x_m'][300], smoothed_center_df['y_m'][300], color='magenta', marker='o', s=100, label='300')
plt.scatter(smoothed_center_df['x_m'][400], smoothed_center_df['y_m'][400], color='blue', marker='o', s=100, label='400')
plt.scatter(smoothed_center_df['x_m'][500], smoothed_center_df['y_m'][500], color='black', marker='o', s=100, label='500')
